...
if ( ! class_exists( 'Revelstoke_Weather_Updater' ) ) :
     ...
     */
    class Revelstoke_Weather_Updater {
        ...
        public function __construct( $config = array() ) {
            ...
            if ( ( defined('WP_DEBUG') && WP_DEBUG ) || ( defined('REVELSTOKE_WEATHER_FORCE_UPDATE') || REVELSTOKE_WEATHER_FORCE_UPDATE ) )
